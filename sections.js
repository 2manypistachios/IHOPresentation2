...
let healthToGDP = [
    { name: "US Annual Healthcare Cost", value: 3.6*10^12 },
    { name: "US GDP", value: 3.6*10^12 /17*100}
]

let americansUninsured = { name: "uninsuredAmericans", value: 2.8*10^6, growth_value: .005}
...
let medicareValues = {
    medicareCost: 5.82*10^9,
    medicareMembers: 5.5*10^6,
    annualCost: 10600,
    coverAdditional: 296*10^9
}
...
function drawInitial(){
    ...
    simulation = d3.forceSimulation(healthToGDP)
    ...
    simulation  
        ...
        .force('forceX', d3.forceX(d => 200))
        .force('forceY', d3.forceY(d => 50))
        .force('collide', d3.forceManyBody().strength(-200))
        .alphaDecay([0.02])
